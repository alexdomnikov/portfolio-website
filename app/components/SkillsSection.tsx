	...
	return (
		<section className="bg-gray-800 py-12 sm:py-20">
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				<h2 className="text-xl sm:text-2xl font-bold text-white mb-6 sm:mb-8 text-center">Languages</h2>
		...
		<h2 className="text-xl sm:text-2xl font-bold text-white mb-6 sm:mb-8 text-center">Libraries, Frameworks, and Tools</h2>
				<div className="flex flex-wrap justify-center gap-4">
					{tools.map((tool) => (
						<div
							key={tool}
